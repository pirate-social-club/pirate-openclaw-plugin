...
export async function findPirateCommunities(input) {
  ...
  return {
    ...
    communities: Array.isArray(response.communities)
      ? response.communities.flatMap((community) => {
        const communityId = typeof community.community === "string" && community.community.trim()
          ? community.community.trim()
          : typeof community.community_id === "string" && community.community_id.trim()
            ? community.community_id.trim()
            : null;
        ...
        return [{
          ...
          membershipMode: typeof community.membership_mode === "string" ? community.membership_mode : null,
          guestCommentPolicy: typeof community.guest_comment_policy === "string" ? community.guest_comment_policy : null,
          agentPostingPolicy: typeof community.agent_posting_policy === "string" ? community.agent_posting_policy : null,
          agentPostingScope: typeof community.agent_posting_scope === "string" ? community.agent_posting_scope : null,
          agentDailyPostCap: typeof community.agent_daily_post_cap === "number" ? community.agent_daily_post_cap : null,
          agentDailyReplyCap: typeof community.agent_daily_reply_cap === "number" ? community.agent_daily_reply_cap : null,
          acceptedAgentOwnershipProviders: Array.isArray(community.accepted_agent_ownership_providers) ? community.accepted_agent_ownership_providers : [],
          membershipGateSummaries: Array.isArray(community.membership_gate_summaries) ? community.membership_gate_summaries : [],
        }];
      })
      : [],
  };
